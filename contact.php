<?php include "header.php"; ?>
      ...
      <div class="row">
         ...
         <div class="panel panel-default">
            ...
            <h2 style="text-muted"><span class="glyphicon glyphicon-list"></span>Kontak</h2>
            <?php 
               ...
               <form action="proses-komentar.php" method="post">
                  <table class="table table-hover">
                     ...
                     <tr>
                        <td>No Handphone
                        <input type="text" name="Handphone" class="form-control input-md" placeholder="Isikan No Handphone" required>
                        </td>
                     </tr>
                     <tr>
                        <td>Pesan
                     ...
                     <tr>
                        <td>
                        <input type="submit" value="Kirim" class="btn btn-lg btn-info">
